<template>
  <div class="product-detail__comments">
    ...
    <div class="product-detail__comments__content">
      ...
      <div 
        class="product-detail__comments__content--reviews"
        v-else
      >
        <form action="" @submit="handleSunmit">
          ...
          <div class="form-group">
            ...
            <textarea name="feedback" rows="4" cols="36" placeholder="Feedback..." />
          </div>

          <div class="form-group">
            <base-input name="name" type="text" placeholder="Name..." label="NAME *" />
          </div>

          <div class="form-group">
            <base-input name="email" type="text" placeholder="Email..." label="EMAIL *" />
          </div>
